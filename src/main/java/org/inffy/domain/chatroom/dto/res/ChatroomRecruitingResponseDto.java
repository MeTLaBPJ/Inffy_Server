...
@Schema(description = "모집중인 채팅룸 정보 Response")
@Getter
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class ChatroomRecruitingResponseDto {
    ...
    @Schema(description = "현재 남자 인원 수", example = "2")
    private Integer currentMaleCount;

    @Schema(description = "현재 여자 인원 수", example = "2")
    private Integer currenFemaleCount;
}
